...
var __gwtModuleFunction = $wnd.eu_dusse_vaadin_waypoints_demo_DemoWidgetSet;
var $sendStats = __gwtModuleFunction.__sendStats;
$sendStats('moduleStartup', 'moduleEvalStart');
var $gwt_version = "7.5.8";
var $strongName = '';
var $gwt = {};
...
function getCodeServer() {
  ...
  if (idx >= 0) {
    ...
    idx = query.indexOf("gwt.codesvr.eu.dusse.vaadin.waypoints.demo.DemoWidgetSet=");
    idx += (13 + "eu.dusse.vaadin.waypoints.demo.DemoWidgetSet".length);  // 
  }
  if (idx >= 0) {
...
//# sourceURL=eu.dusse.vaadin.waypoints.demo.DemoWidgetSet-0.js
